...
export const generateMetadata = async () => {
  return {
    ...
    description: 'GDC Consultants provides innovative solutions and expert guidance in architectural and engineering design. Serving New Zealand with a commitment to excellence.',
    keywords: 'engineering consultants, architectural design, New Zealand engineering, GDC Consultants, structural engineering, building design',
    openGraph: {
      title: 'GDC Consultants | Engineering & Architectural Design Solutions',
