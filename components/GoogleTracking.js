  ...
  return (
    <>
      <Script
        ...
        onError={() =>
          logAnalytics("Script error", "Base script failed to load")
        }
      />
      <Script
        id="google-tracking"
        ...
        onLoad={() =>
          logAnalytics("Config loaded", "Analytics configuration complete")
        }
        onError={() =>
          logAnalytics("Config error", "Analytics configuration failed")
        }
      />
