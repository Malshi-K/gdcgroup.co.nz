  ...
  const handleShowMoreClick = useCallback(() => {
    ...
    setCurrentPage(prevPage => {
      ...
      setTimeout(() => {
        ...
        const lastVisibleProject = document.getElementById(`project-${lastVisibleProjectIndex}`);
          ...
          <>
              ...
              {displayedProjects.map((project, index) => (
                <div
                  ...
                  className={`bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer ${
                    index >= (currentPage - 1) * PROJECTS_PER_PAGE ? 'animate-fadeIn' : ''
                  }`}
                  ...
                  <div className="p-4">
                    ...
                    {project.relatedImages.length > 1 && (
                      <div className="mt-3 text-customBlue flex items-center">
                        <span className="text-sm">View all {project.relatedImages.length} images</span>
                        <svg 
            ...
            {remainingProjects > 0 && (
              <div className="flex justify-center mt-8">
                ...
                >
                  <span>
                    Show More Projects ({remainingProjects} remaining of {groupedProjects.length} total)
                  </span>
                  <svg 
            ...
            <div className="text-center mt-4 text-sm text-gray-600">
              Showing {Math.min(currentPage * PROJECTS_PER_PAGE, groupedProjects.length)} of {groupedProjects.length} projects
            </div>
          </>
        ) : (
          ...
          >
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-customBlue">{selectedProject.title}</h2>
                <button 
